...
public:
	...
	friend ostream & operator << (ostream & strm, ListNode<T> *nodePtr);
	friend ofstream & operator << (ofstream & outFile, ListNode<T> *nodePtr);
	...
	void printListToFile(ofstream &) const;
};
...
//**************************************************
// printListToFile                                 *
// print to a file the value stored in each node   *
// of the linked list pointed to by head.          *
//**************************************************

template <class T>
void LinkedList<T>::printListToFile(ofstream & outfile) const
{
	ListNode<T> *nodePtr;  // To move through the list
	...
	while (nodePtr)
	{
		// print to outfile stream the value in this node.
